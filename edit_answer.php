...
//2. 입력값 확인
$newAnswerContents = $_POST['answerContentsTextarea'];
$answerIdToUpdate = $_POST['editAnswerId'];
...
try{
    ...
    //쿼리 작성
    $sql= "UPDATE answers SET answerContents = :newAnswerContents WHERE answerId = :answerIdToUpdate";
   ...
   $stmt ->bindParam(':newAnswerContents', $newAnswerContents, PDO::PARAM_STR);
   $stmt ->bindParam(':answerIdToUpdate', $answerIdToUpdate, PDO::PARAM_INT);
